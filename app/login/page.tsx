          ...
          {sent ? (
            ...
            <form onSubmit={handleSubmit}>
              ...
              <input
                ...
                required
                autoFocus
                className="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm text-gray-900 bg-white placeholder:text-gray-400 mb-4 focus:outline-none focus:ring-2 focus:ring-teal-500"
              />
